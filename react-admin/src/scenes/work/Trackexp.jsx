...
import { checkTrackExp, deleteAllTrackEXP, trackexp } from "../../api/tracking";
        ...
        if (trackedProduct) {
          return (
            <Box display="flex-row">
              ...
              >
                Tracked. ({trackedProduct.expCount})
              </span>
              <DialogExp
                productId={productId}
